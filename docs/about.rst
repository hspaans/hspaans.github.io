...
I started my journey in technology a long time ago, driven by curiosity and a desire to understand how things work. The original start was in :grokipedia:`electronic engineer <Electronic_engineering>`, but quickly shifted to programming :grokipedia:`PLCs <Programmable_logic_controller>` and embedded systems. Over time, this passion evolved into a career in :grokipedia:`software engineering <Software_engineering>`. A starting point was learning various programming languages and frameworks, which laid the foundation for my understanding of software development and systems architecture. And completing my studies in computer science further solidified my knowledge and skills.
...
As I look to the future, I'm excited about the possibilities that technology holds. I plan to continue exploring new areas such as cloud computing, DevOps and FinOps practices, and emerging technologies like AI and machine learning. My goal is to keep learning, sharing, and contributing to the tech community while also working on projects that make a positive impact. That is also the reason for this website, to share my journey, projects, and insights with others who share similar interests.
